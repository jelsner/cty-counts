...
Shrink SPC tracks by a proportion to account for the fact that EF2+ damage occurs only for a portion of the track. Look in here to see how you can perform affine transformations of geometries. https://geocompr.robinlovelace.net/geometric-operations.html
